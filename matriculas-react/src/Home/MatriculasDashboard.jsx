...
// ─── Mock API ──────────────────────────────────────────────────────────────────
// Substitua estas funções pelos seus fetch() reais
...
const API = {
  ...
  async getIESRanking(filters) {
    ...
    const all = [
      ...
      { ies: "Anhanguera", tipo: "privada", modalidade: "ead", alunos: 290_000 },
      { ies: "UNOPAR", tipo: "privada", modalidade: "ead", alunos: 260_000 },
      { ies: "USP", tipo: "publica", modalidade: "presencial", alunos: 100_000 },
      { ies: "UNICAMP", tipo: "publica", modalidade: "presencial", alunos: 35_000 },
      { ies: "UFRJ", tipo: "publica", modalidade: "presencial", alunos: 50_000 },
      { ies: "Kroton", tipo: "privada", modalidade: "presencial", alunos: 210_000 },
      { ies: "Estácio", tipo: "privada", modalidade: "ead", alunos: 195_000 },
      { ies: "UNESP", tipo: "publica", modalidade: "presencial", alunos: 45_000 },
      { ies: "Pitágoras", tipo: "privada", modalidade: "ead", alunos: 170_000 },
      { ies: "UFMG", tipo: "publica", modalidade: "presencial", alunos: 48_000 },
      { ies: "Mackenzie", tipo: "privada", modalidade: "presencial", alunos: 55_000 },
    ];
    return all.filter((d) => {
      if (filters.tipo !== "todos" && d.tipo !== filters.tipo) return false;
      if (filters.modalidade !== "todos" && d.modalidade !== filters.modalidade) return false;
      return true;
    });
  },
};
...
const fmtFull = (n) => new Intl.NumberFormat("pt-BR").format(n);
